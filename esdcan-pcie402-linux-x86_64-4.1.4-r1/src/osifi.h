...
extern INT32 OSIF_CALLTYPE osif_memcpy(VOID *dst, const VOID *src, UINT32 size);
extern INT32 OSIF_CALLTYPE osif_memcmp(const VOID *dst, const VOID *src, UINT32 size);
