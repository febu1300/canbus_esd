...
/*
 *      Provide an empty definition of a system specific memory barrier
 *      operation. For details why this may be needed see Mantis #789.
 *      If it is needed the system specific osifi.h must provide a
 *      valid implementation.
 */
#ifndef OSIF_MEM_BARRIER
# define OSIF_MEM_BARRIER
#endif
...
/*
 * Provide an offsetof() style macro if envirionment doesn't provide one.
 */
#if defined(offsetof)
#       define OSIF_OFFSETOF(type, element) offsetof(type, element)
#else
#       define OSIF_OFFSETOF(type, element) ((size_t)&(((type *)0)->element))
#endif
...
#  define OSIF_BUILD_INFO __DATE__ " @ " __TIME__
# endif /* of _MSC_VER */
#else /* The Clang compiler */
# define OSIF_BUILD_INFO __DATE__ " @ " __TIME__ \
           " with Clang V" OSIF_INT2STRING(__clang_major__) "." OSIF_INT2STRING(__clang_minor__)
#endif /* of !defined __clang__ */
